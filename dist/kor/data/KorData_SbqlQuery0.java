...
public class KorData_SbqlQuery0 {
    private com.db4o.ObjectContainer db;
    private java.lang.String name;

    public KorData_SbqlQuery0(final com.db4o.ObjectContainer db,
    ...
    /**
     * original query='db.( Class as c.((c.name, c.shortname) where c.shortname == name ))'
     *
     * query after optimization='db.(Class as c where c.getShortname() == name).(c.getName(), c.getShortname())'
    */
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> _queryResult =
            _ident_db.query(new KorData_SbqlQuery0Db4o0(name));
