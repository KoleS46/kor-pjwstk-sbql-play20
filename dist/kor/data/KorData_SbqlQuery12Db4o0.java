...
public class KorData_SbqlQuery12Db4o0 implements Db4oSBQLQuery {
    private java.lang.String klass;

    public KorData_SbqlQuery12Db4o0(java.lang.String klass) {
        this.klass = klass;
    }

    /**
     * query='db.(Class as c where c.getShortname() != klass).(c.getShortname(), c.getName())'
    '
     **/
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery(
        ...
        for (long _id13 : _ids13) {
            ...
            _ident_Class.add((kor.model.Class) _ref13.getObject());
        }
        ...
        for (kor.model.Class _whereEl : _asResult_c) {
            ...
            java.lang.String _ident_klass = klass;
            java.lang.Boolean _not_equalsResult = !OperatorUtils.equalsSafe(_mth_getShortnameResult,
                    _ident_klass);
        ...
        for (kor.model.Class _dotEl3 : _whereResult) {
            ...
            java.lang.String _mth_getShortnameResult1 = _dotEl1.getShortname();
            ...
            pl.wcislo.sbql4j.java.model.runtime.Struct _commaResult = OperatorUtils.cartesianProductSS(_mth_getShortnameResult1,
                    _mth_getNameResult, "", "");
