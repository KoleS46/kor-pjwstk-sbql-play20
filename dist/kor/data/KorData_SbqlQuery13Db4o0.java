...
public class KorData_SbqlQuery13Db4o0 implements Db4oSBQLQuery {
    public KorData_SbqlQuery13Db4o0() {
    }

    /**
     * query='db.( max(Student.getAge()) group as _aux0).(Student as s where s.getAge() == _aux0).s'
    '
     **/
    public java.util.Collection<kor.model.Student> executeQuery(
        ...
        for (long _id14 : _ids14) {
            ...
            _ident_Student.add((kor.model.Student) _ref14.getObject());
        }
        ...
        for (long _id15 : _ids15) {
            ...
            _ident_Student1.add((kor.model.Student) _ref15.getObject());
        }
