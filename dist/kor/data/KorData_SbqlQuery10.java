...
public class KorData_SbqlQuery10 {
    private com.db4o.ObjectContainer db;

    public KorData_SbqlQuery10(final com.db4o.ObjectContainer db) {
        this.db = db;
    }

    /**
     * original query='db.( Student as s.((s.fname, s.sname, s.year) where s.year != 1 ) )'
     *
     * query after optimization='db.(Student as s where s.getYear() != 1).(s.getFname(), s.getSname(), s.getYear())'
    */
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> _queryResult =
            _ident_db.query(new KorData_SbqlQuery10Db4o0());
